      ...
      subsections: [
        {
          title: '스킬의 핵심 가치',
          blocks: [
            { type: 'paragraph', content: '스킬을 도입하면 반복적인 작업을 자동화하고, 팀의 전문지식을 체계화하며, 일관된 품질의 결과물을 보장할 수 있습니다. 아래 다이어그램은 스킬이 제공하는 5가지 핵심 가치를 보여줍니다.' },
            { type: 'diagram', diagramId: 'skill-core-values' },
            { type: 'paragraph', content: '위 다이어그램에서 볼 수 있듯이, 스킬의 5가지 핵심 가치는 다음과 같습니다:' },
            { type: 'items', items: [
              { label: '재사용성', desc: '한 번 작성하면 무한히 재사용할 수 있습니다. 같은 작업을 반복할 때마다 처음부터 설명할 필요가 없습니다.' },
              { label: '일관성', desc: '매번 동일한 품질과 형식의 결과를 보장합니다. 사람마다, 시간마다 결과가 달라지는 문제를 해결합니다.' },
              { label: '공유 가능성', desc: '팀원들과 쉽게 공유하고 협업할 수 있습니다. 조직 관리자는 워크스페이스 전체에 스킬을 배포할 수 있습니다.' },
        ...
        },
        {
          ...
          blocks: [
            ...
            { type: 'tip', content: '프로그레시브 디스클로저(Progressive Disclosure)란 스킬의 전체 내용을 한 번에 로드하지 않고, 필요한 시점에 필요한 부분만 로드하여 토큰을 절약하는 기법입니다. 이에 대해서는 "핵심 설계 원칙" 섹션에서 자세히 다룹니다.' },
          ],
        },
        {
          title: '스킬 도입 효과 분석',
          blocks: [
            { type: 'paragraph', content: '스킬을 도입하면 실제로 얼마나 효율이 개선될까요? 아래 다이어그램과 표는 스킬 도입 전후의 차이를 보여줍니다.' },
            { type: 'diagram', diagramId: 'skill-value-flow' },
            { type: 'paragraph', content: '위 다이어그램에서 볼 수 있듯이, 스킬을 사용하면 워크플로우가 자동화되고 메시지 교환 횟수가 크게 줄어듭니다. 구체적인 수치로 비교해 보겠습니다:' },
            { type: 'comparison', data: {
            ...
            { type: 'note', content: '이 수치는 공식 가이드 Testing 챕터(페이지 16)의 Performance Comparison 시나리오 예시입니다. 실제 결과는 사용 사례, MCP 서버 성능, 스킬 복잡도에 따라 다를 수 있습니다.' },
          ],
        },
        {
          title: '다음 단계',
          blocks: [
            { type: 'paragraph', content: '지금까지 스킬이 무엇이고 왜 필요한지 알아보았습니다. 다음 섹션에서는 이 가이드가 누구를 위한 것인지, 그리고 여러분의 목표에 맞는 학습 경로를 안내해 드리겠습니다.' },
            { type: 'tip', content: 'MCP 서버가 이미 있고 자동화하고 싶은 상위 2~3개 워크플로우를 알고 있다면, 15~30분 만에 첫 번째 스킬을 구축하고 테스트할 수 있습니다!' },
          ],
        },
      ],
    },
      ...
      subsections: [
        {
          title: '대상 독자',
          blocks: [
            { type: 'paragraph', content: '공식 가이드에서는 세 가지 유형의 독자를 명시하고 있습니다. 아래 다이어그램은 각 독자 유형별 학습 경로를 보여줍니다.' },
            { type: 'diagram', diagramId: 'target-audience' },
            { type: 'paragraph', content: '여러분은 어떤 유형에 해당하시나요? 각 유형별 특징을 자세히 살펴보겠습니다:' },
            { type: 'items', items: [
              ...
              { label: '팀 (Teams)', desc: '팀 전체의 워크플로우를 표준화하고 효율을 높이고 싶은 조직. 관리자가 워크스페이스 전체에 스킬을 배포할 수 있으며, 자동 업데이트와 중앙 관리가 가능합니다.' },
            ]},
          ],
        },
        {
          title: '가이드 구성',
          blocks: [
            { type: 'paragraph', content: '이 가이드는 스킬 개발의 전 과정을 체계적으로 다루는 6개 챕터와 빠른 참조를 위한 3개 부록으로 구성되어 있습니다.' },
            { type: 'items', items: [
              { label: '제1장: 기초', desc: '스킬의 구조, 핵심 설계 원칙, MCP와의 관계를 이해합니다. 스킬의 기본을 탄탄히 다지는 단계입니다.' },
              { label: '제2장: 설계와 기획', desc: '유스 케이스 정의부터 기술 요구사항, YAML 프론트매터, 효과적인 지시사항 작성까지의 전 과정을 다룹니다.' },
              { label: '제3장: 테스트와 반복', desc: '수동/스크립트/API 테스트 방법과 피드백 기반 반복 개선을 배웁니다. 품질 보증의 핵심입니다.' },
              { label: '제4장: 배포와 공유', desc: '배포 모델, 오픈 스탠다드, API 연동, 포지셔닝 전략을 다룹니다. 스킬을 세상에 공개하는 방법입니다.' },
              { label: '제5장: 패턴과 문제 해결', desc: '검증된 5가지 패턴과 일반적인 문제 해결법을 다룹니다. 실전에서 바로 적용할 수 있는 노하우입니다.' },
              { label: '제6장: 리소스', desc: '공식 문서, 예제, 도구, 지원 채널을 안내합니다. 추가 학습을 위한 길잡이입니다.' },
            ]},
            { type: 'tip', content: 'MCP 서버가 있고 상위 2~3개 워크플로우를 알고 있다면, 한 번의 세션에서 15~30분 만에 기능하는 스킬을 구축하고 테스트할 수 있습니다.' },
          ],
        },
      ],
    },
      ...
      subsections: [
        {
          ...
          blocks: [
            { type: 'paragraph', content: '독립형 스킬은 외부 서비스 연동 없이 Claude의 내장 도구만으로 동작하는 스킬입니다. MCP 서버 설정이 필요 없어 빠르게 시작할 수 있으며, 코드 생성, 문서 작성, 분석 프레임워크 등에 적합합니다.' },
            { type: 'paragraph', content: '독립형 스킬의 핵심 특징:' },
            { type: 'items', items: [
              { label: '핵심 챕터', desc: '기초(Ch.1)와 설계 & 기획(Ch.2)에 집중하세요' },
              { label: '사용 가능한 도구', desc: 'Read, Write, Edit, Bash, Glob, Grep, WebFetch, WebSearch' },
              { label: '적합한 예시', desc: '코드 리뷰 스킬, 문서 생성 스킬, 분석 프레임워크 스킬' },
            ]},
            { type: 'tip', content: '코딩 경험이 없어도 독립형 스킬을 만들 수 있습니다. SKILL.md 파일은 마크다운 형식이므로 특별한 프로그래밍 지식이 필요하지 않습니다.' },
          ],
        },
        {
          title: '경로 2: MCP 강화 스킬 (MCP-Enhanced Skills)',
          blocks: [
            { type: 'paragraph', content: 'MCP 강화 스킬은 MCP(Model Context Protocol) 서버를 통해 GitHub, Slack, 데이터베이스, Figma 등 외부 서비스와 연동하는 스킬입니다.' },
            { type: 'paragraph', content: 'MCP와 스킬의 관계를 이해하는 것이 중요합니다. MCP는 외부 서비스와의 "연결"을 담당하고, 스킬은 그 연결을 "어떻게 사용할지"에 대한 지식을 제공합니다.' },
            { type: 'items', items: [
              { label: '핵심 챕터', desc: '"MCP와 스킬"(Ch.1) 섹션을 반드시 읽으세요' },
              { label: 'MCP가 제공하는 것', desc: '연결성(Connectivity) — 외부 서비스와의 통신 채널' },
              { label: '스킬이 제공하는 것', desc: '지식(Knowledge) — 언제, 어떻게, 어떤 순서로 도구를 사용할지에 대한 가이드' },
            ]},
            { type: 'warning', content: '스킬 없이 MCP만 사용하면 사용자가 무엇을 할 수 있는지 모르고, 결과가 일관되지 않으며, 지원 요청이 증가합니다. 스킬을 추가하면 사전 구축된 워크플로우, 일관된 사용 방식, 베스트 프랙티스가 내장됩니다.' },
          ],
        },
        {
          title: '어떤 경로를 선택해야 할까요?',
          blocks: [
            { type: 'paragraph', content: '어떤 경로를 선택할지 고민되시나요? 다음 기준을 참고해 보세요:' },
            { type: 'items', items: [
              '외부 서비스(GitHub, Slack 등) 연동이 필요하다 → MCP 강화 스킬',
              'Claude의 기본 기능만으로 충분하다 → 독립형 스킬',
              '빠르게 시작하고 싶다 → 독립형 스킬로 시작',
              '복잡한 워크플로우를 자동화하고 싶다 → MCP 강화 스킬',
            ]},
            { type: 'tip', content: '처음에는 독립형 스킬로 시작한 후, 필요에 따라 MCP 도구를 추가하는 것도 좋은 방법입니다. 두 접근 방식은 상호 배타적이지 않습니다!' },
          ],
        },
      ],
      highlights: [
        '두 유형 모두 동일한 SKILL.md 형식을 사용합니다.',
        '독립형 스킬은 기초(Ch.1)와 설계(Ch.2)에 집중하세요.',
